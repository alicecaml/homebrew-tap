class Alice < Formula
  ...
  url "https://github.com/alicecaml/alice/archive/refs/tags/0.2.0.tar.gz"
  ...
  def install
    ...
    # Dune downloads and builds dependencies of all packages in the project,
    # but it's a waste of time to build dependencies only required for tests.
    # Remove these packages from the lock directory to speed up building Alice.
    ohai "Removing test-only dependencies from lock directory to speed up build..."
    [
      "base.v0.17.3.pkg",
      "csexp.1.5.2.pkg",
